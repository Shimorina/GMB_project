...
def drg_mining(file_path):
	...
	with open('training_data.txt', 'a') as f:
		...
		for i in range(len(events) - 1):
			...
			arguments2 = [feat.split(':')[1] for feat in features2]
			common_elements = [val for val in arguments if val in set(arguments2)]
